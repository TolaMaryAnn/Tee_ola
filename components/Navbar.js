...
const Navbar = () => {
  ...
  >
    <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
      ...
      <div>
        <ul style={{ color: `${linkColor}` }} className='hidden md:flex font-[Raleway]'>
        ...
        <div>
          ...
          <div className='border-b border-gray-300 my-4'>
            <p className='w-[85%] md:w-[90%] py-4'>
              Let&#39;s build something legendary and awesome together
            </p>
          </div>
        </div>
        <div className='py-4 flex flex-col font-[Raleway]'>
