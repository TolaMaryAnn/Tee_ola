...
import edu from '../public/assets/edu.png'
  ...
  return (
    ...
    <div className='w-screen h-[50vh]  relative'>
      ...
      <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
        <h2 className='py-2 text-3xl sm:text-4xl font-bold'>E-learning</h2>
        <h3 className='text-2xl sm:text-3xl '>React JS/Css</h3>
      </div>
    </div>
    ...
    <div className='max-w-[1240px] mx-auto p-4 grid md:grid-cols-5 gap-8 py-1  '>
      <div className='col-span-4'>
        ...
        <p className='py-2 text-gray-600'>
          This app was built using React JS and is hosted on Vercel. An online-learning platform.
        </p>
        <Link
          href='https://github.com/TolaMaryAnn/Educamia'
          target='_blank'
          rel='noreferrer'
        >
        ...
        <Link
          href='https://educamia.vercel.app/'
          target='_blank'
          rel='noreferrer'
        >
