...
import xibeplug from "../public/assets/xibeplug.png";
    ...
    <div className="w-full font-[Raleway] ] tracking-wide">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2 text-3xl sm:text-4xl font-bold">
            Fashion studio
          </h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-1 ">
        <div className="col-span-4">
          <p className=" text-gray-600">Project</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-[#c69c72]">
            Overview
          </h2>
          <p className="py-2 text-gray-600">
            This app was built using React JS and is hosted on Vercel. A Fashion
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4">
          <div className="p-2">
            <p className="text-center font-bold pb-2 text-[#c69c72]">
              Technologies
            </p>
